...
const LandingPage = () => {
  ...
  const handleBookDemo = (formData = null) => {
    if (formData) {
      ...
      // Success modal is now disabled as we show it in the card
        ...
        <div className="bg-white rounded-3xl p-8 max-w-md w-full shadow-testimonial border border-border">
          <div className="text-center">
            ...
            <p className="text-text-secondary mb-6">
              Thank you {bookingData?.name}! We've sent an email confirmation to {bookingData?.email} with your booking details and coach introduction video.
            </p>
            ...
            <div className="bg-green-50 rounded-xl p-4 mb-6 border border-green-200">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <span className="text-green-700 font-medium text-sm">Email confirmation sent!</span>
              </div>
              <p className="text-green-600 text-sm">
                Check your email for booking details and coach introduction video.
              </p>
            </div>
